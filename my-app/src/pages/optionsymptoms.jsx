...
const OptionSection = () => {
  ...
  return (
    <section className={styles["services-section"]}>
      <h2 className={styles["section-title"]} data-aos="fade-down">What would you like to explore?</h2>
      <p className={styles.servicep}>Explore AI-powered solutions tailored for your everyday health and wellness needs</p>
